...
const story = (id: string, page: number, text: string, preposition: string, image: string): SceneDefinition => ({
  id, storyPage: page, storyText: text, preposition, image,
  alt: `Storybook page ${page}. ${text}`, width: UI_WIDTH, height: UI_HEIGHT,
...
const question = (id: string, prompt: string, correct: string, choices: readonly string[], image: string): SceneDefinition => ({
  id, question: prompt, correct, choices, image, alt: `Story question. ${prompt}`,
  width: UI_WIDTH, height: UI_HEIGHT,
  hotspots: choices.map((choice) => point(`Answer ${choice}`, choice, "answer")),
});

export const scenes: readonly SceneDefinition[] = [
  { id: "title", image: "/exact/title.png", alt: "Princess. A magical adventure for learning prepositions.", width: 512, height: 322, hotspots: [{ label: "Begin the Adventure", x: 51, y: 202, width: 152, height: 35, action: "start" }] },
  {
    id: "word-scattering", image: "/exact/forest.png", alt: "Word Scattering. Find the preposition UNDER.", width: UI_WIDTH, height: UI_HEIGHT, correct: "under",
    hotspots: [point("Choose THE", "the", "answer"), point("Choose PRINCESS", "princess", "answer"), point("Choose IS", "is", "answer"), point("Choose UNDER", "under", "answer"), point("Choose TREE", "tree", "answer"), point("Choose CASTLE", "castle", "answer")],
  },
  {
    id: "sentence-reconstruction", image: "/exact/forest.png", alt: "Sentence Reconstruction. Build: The princess is under the tree.", width: UI_WIDTH, height: UI_HEIGHT,
    sequence: ["the-1", "princess", "is", "under", "the-2", "tree", "period"],
    hotspots: [point("Word THE", "the-1", "sequence"), point("Word PRINCESS", "princess", "sequence"), point("Word IS", "is", "sequence"), point("Word UNDER", "under", "sequence"), point("Word THE second", "the-2", "sequence"), point("Word TREE", "tree", "sequence"), point("Word PERIOD", "period", "sequence")],
  },
  {
    id: "picture-matching", image: "/exact/garden.png", alt: "Picture Matching. Match each picture to its sentence.", width: UI_WIDTH, height: UI_HEIGHT,
    sequence: ["under", "on", "in"],
    hotspots: [point("The princess is UNDER the tree", "under", "sequence"), point("The princess is ON the stones", "on", "sequence"), point("The princess is IN the garden", "in", "sequence")],
  },
  { id: "storybook-intro", image: "/exact/title.png", alt: "Digital Storybook. Read the whole adventure before the memory challenge.", width: UI_WIDTH, height: UI_HEIGHT, hotspots: [point("Open Storybook", "begin", "advance")] },
  ...
  {
    id: "story-puzzle", image: "/exact/garden.png", question: "Complete Princess's journey.", alt: "Final story puzzle. Rebuild the nine prepositions in story order.", width: UI_WIDTH, height: UI_HEIGHT,
  ...
  { id: "completion", image: "/exact/ending.png", alt: "The End. Princess completed her adventure and all nine position words were discovered.", width: UI_WIDTH, height: UI_HEIGHT, hotspots: [point("Play Again", "replay", "replay"), point("Read the Story Again", "story", "next")] },
] as const;
